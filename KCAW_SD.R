...
# 
# 
sen22 <- read.csv('/Users/birdieligos/Downloads/sdkcaw - senate22 (1).csv', stringsAsFactors = FALSE)

atg22 <- read.csv('/Users/birdieligos/Downloads/sdkcaw - attorneygen22.csv', stringsAsFactors = FALSE)

gov22 <- read.csv('/Users/birdieligos/Downloads/sdkcaw - gov22.csv', stringsAsFactors = FALSE)

pres24 <- read.csv('/Users/birdieligos/Downloads/sdkcaw - pres24.csv', stringsAsFactors = FALSE)

pres20 <- read.csv('/Users/birdieligos/Downloads/sdkcaw - pres20.csv', stringsAsFactors = FALSE)

sen22 <- sen22 %>% select(District, DEM = 3, REP = 4)
...
# 
# write.csv(merged, file = '/Users/birdieligos/Documents/Reports/CASenatedistrictcomposities.csv', row.names = FALSE)
...
write.csv(
  merged,
  '/Users/birdieligos/Documents/Reports/CA_SD_PVI_dynamic.csv',
  row.names = FALSE
)
...
write.csv(
  swing_df,
  '/Users/birdieligos/Documents/Reports/CA_SD_shift.csv',
  row.names = FALSE
)
